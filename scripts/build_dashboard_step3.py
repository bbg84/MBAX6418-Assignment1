...
<script>
  ...
  all.innerHTML = `<table><thead><tr><th>Rating</th><th>Correct label</th><th>Model said</th><th>Verdict</th><th>Review</th></tr></thead><tbody>` +
    rows.map(rowEsc).join('') + `</tbody></table>`;
